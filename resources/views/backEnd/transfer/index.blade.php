...
<div class="panel panel-default">
    ...
    {!! Form::open(['url' => 'transfer/store', 'class' => 'form-horizontal']) !!}
            ...
            <div class="form-group {{ $errors->has('slug') ? 'has-error' : ''}}">
                ...
                QR Code Value:
                <input type="text" class="input-group-text" id="qrCode"name="qrCode" style="display: inline-block;" disabled> <!-- This is required cause the result will be added to this. Could be put any where -->
                <!-------------------------->
